...
Open an SSH connection to MARCC from a Larman Lab affiliated account. Execute the following commands.
...
Install [R (3.5+)](https://www.r-project.org/) and [RStudio](https://www.rstudio.com/). 

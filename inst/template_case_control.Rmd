...
* Promax is a protein-level metric indicating the highest zscore among the peptide fragments for a given protein.  
* Polyclonal indicates the number of non-overlapping peptide fragments of a given protein that produce z-score hit. 
...
* the larger of (i) n = `r config$vlaue[config$param == "min_hits_rcp"]` or (ii) `r config$vlaue[config$param == "min_freq_hits_rcp"] * 100`% rounded up) of cases scored above the 95th percentile of the control population,
